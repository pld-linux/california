...
Source0:	http://ftp.gnome.org/pub/GNOME/sources/california/0.1/%{name}-%{version}.tar.xz
# Source0-md5:	5bb803a6177970960260520ba0b0bb7c
...
BuildRequires:	gtk+3-devel >= 3.10.7
